 ...
 */
!function(o){"use strict";o("a.page-scroll").bind("click",function(t){var r=o(this);o("html, body").stop().animate({scrollTop:o(r.attr("href")).offset().top-50},1250,"easeInOutExpo"),t.preventDefault()}),o("body").scrollspy({target:".navbar-fixed-top",offset:51}),o(".navbar-collapse ul li a").click(function(){o(".navbar-toggle:visible").click()}),o("#mainNav").affix({offset:{top:100}}),o("#services .fa-list-ol").hover(function(){o(this).toggleClass("animated bounceIn")}),o("#services .fa-comments-o").hover(function(){o(this).toggleClass("animated swing")}),o("#services .fa-play").hover(function(){o(this).toggleClass("animated lightSpeedOut")}),o("#contact .fa-envelope").hover(function(){o(this).toggleClass("animated zoomOutRight")}),window.matchMedia("(max-width: 767px)").matches?(o("#licht-gray").attr("src","img/portfolio/project1-gray-mobile.jpg"),o("#licht-color").attr("src","img/portfolio/project1-mobile.jpg"),o("#ton-gray").attr("src","img/portfolio/project2-gray-mobile.jpg"),o("#ton-color").attr("src","img/portfolio/project2-mobile.jpg"),o("#video-gray").attr("src","img/portfolio/project3-gray-mobile.jpg"),o("#video-color").attr("src","img/portfolio/project3-mobile.jpg"),o("#buehne-gray").attr("src","img/portfolio/project4-gray-mobile.jpg"),o("#buehne-color").attr("src","img/portfolio/project4-mobile.jpg")):(o("#licht-gray").attr("src","img/portfolio/project1-gray.jpg"),o("#licht-color").attr("src","img/portfolio/project1.jpg"),o("#ton-gray").attr("src","img/portfolio/project2-gray.jpg"),o("#ton-color").attr("src","img/portfolio/project2.jpg"),o("#video-gray").attr("src","img/portfolio/project3-gray.jpg"),o("#video-color").attr("src","img/portfolio/project3.jpg"),o("#buehne-gray").attr("src","img/portfolio/project4-gray.jpg"),o("#buehne-color").attr("src","img/portfolio/project4.jpg"))}(jQuery);
/*!
 * Start Bootstrap - Agency v3.3.7+1 (http://startbootstrap.com/template-overviews/agency)
 * Copyright 2013-2017 Start Bootstrap
 * Licensed under MIT (https://github.com/BlackrockDigital/startbootstrap/blob/gh-pages/LICENSE)
 */
!function(e,n){"function"==typeof define&&define.amd?define(["ScrollMagic","TweenMax","TimelineMax"],n):"object"==typeof exports?(require("gsap"),n(require("scrollmagic"),TweenMax,TimelineMax)):n(e.ScrollMagic||e.jQuery&&e.jQuery.ScrollMagic,e.TweenMax||e.TweenLite,e.TimelineMax||e.TimelineLite)}(this,function(e,n,o){"use strict";var t="animation.gsap",r=window.console||{},i=Function.prototype.bind.call(r.error||r.log||function(){},r);e||i("("+t+") -> ERROR: The ScrollMagic main module could not be found. Please make sure it's loaded before this plugin or use an asynchronous loader like requirejs."),n||i("("+t+") -> ERROR: TweenLite or TweenMax could not be found. Please make sure GSAP is loaded before ScrollMagic or use an asynchronous loader like requirejs."),e.Scene.addOption("tweenChanges",!1,function(e){return!!e}),e.Scene.extend(function(){var e,r=this,i=function(){r._log&&(Array.prototype.splice.call(arguments,1,0,"("+t+")","->"),r._log.apply(this,arguments))};r.on("progress.plugin_gsap",function(){a()}),r.on("destroy.plugin_gsap",function(e){r.removeTween(e.reset)});var a=function(){if(e){var n=r.progress(),o=r.state();e.repeat&&e.repeat()===-1?"DURING"===o&&e.paused()?e.play():"DURING"===o||e.paused()||e.pause():n!=e.progress()&&(0===r.duration()?n>0?e.play():e.reverse():r.tweenChanges()&&e.tweenTo?e.tweenTo(n*e.duration()):e.progress(n).pause())}};r.setTween=function(t,l,s){var c;arguments.length>1&&(arguments.length<3&&(s=l,l=1),t=n.to(t,l,s));try{c=o?new o({smoothChildTiming:!0}).add(t):t,c.pause()}catch(u){return i(1,"ERROR calling method 'setTween()': Supplied argument is not a valid TweenObject"),r}if(e&&r.removeTween(),e=c,t.repeat&&t.repeat()===-1&&(e.repeat(-1),e.yoyo(t.yoyo())),r.tweenChanges()&&!e.tweenTo&&i(2,"WARNING: tweenChanges will only work if the TimelineMax object is available for ScrollMagic."),e&&r.controller()&&r.triggerElement()&&r.loglevel()>=2){var p=n.getTweensOf(r.triggerElement()),d=r.controller().info("vertical");p.forEach(function(e,n){var o=e.vars.css||e.vars,t=d?void 0!==o.top||void 0!==o.bottom:void 0!==o.left||void 0!==o.right;if(t)return i(2,"WARNING: Tweening the position of the trigger element affects the scene timing and should be avoided!"),!1})}if(parseFloat(TweenLite.version)>=1.14)for(var g,f,w=e.getChildren?e.getChildren(!0,!0,!1):[e],h=function(){i(2,"WARNING: tween was overwritten by another. To learn how to avoid this issue see here: https://github.com/janpaepke/ScrollMagic/wiki/WARNING:-tween-was-overwritten-by-another")},v=0;v<w.length;v++)g=w[v],f!==h&&(f=g.vars.onOverwrite,g.vars.onOverwrite=function(){f&&f.apply(this,arguments),h.apply(this,arguments)});return i(3,"added tween"),a(),r},r.removeTween=function(n){return e&&(n&&e.progress(0).pause(),e.kill(),e=void 0,i(3,"removed tween (reset: "+(n?"true":"false")+")")),r}})});
/*!
 * Start Bootstrap - Agency v3.3.7+1 (http://startbootstrap.com/template-overviews/agency)
 * Copyright 2013-2017 Start Bootstrap
 * Licensed under MIT (https://github.com/BlackrockDigital/startbootstrap/blob/gh-pages/LICENSE)
 ...
 * Licensed under MIT (https://github.com/BlackrockDigital/startbootstrap/blob/gh-pages/LICENSE)
 */
var controller=new ScrollMagic.Controller;$(function(){function e(){o=new ScrollMagic.Controller,$(".timeline > li").each(function(){var e=this;new ScrollMagic.Scene({triggerElement:e,duration:200}).on("enter",function(o){$direction=o.target.controller().info("scrollDirection"),$(e).addClass("increase")}).on("leave",function(o){$direction=o.target.controller().info("scrollDirection"),$(e).removeClass("increase")}).addTo(o)})}var o=null,n=$(window).width();n>767&&e(),$(window).resize(function(){n=$(window).width(),n<768?controller&&(controller=controller.destroy(!0)):n>767&&(controller||e())}),$(".solid").each(function(){var e=this,o=this.getAttribute("id");new ScrollMagic.Scene({triggerElement:e,triggerHook:"onLeave",offset:-70}).on("enter leave",function(e){$direction=e.target.controller().info("scrollDirection"),"FORWARD"==$direction?$(".navbar-custom").addClass("shadow"):o.includes("team")||$(".navbar-custom").removeClass("shadow")}).addTo(controller)}),$(".transparent").each(function(){var e=this;new ScrollMagic.Scene({triggerElement:e,triggerHook:"onLeave",offset:-70}).on("enter leave",function(e){$direction=e.target.controller().info("scrollDirection"),"FORWARD"==$direction?$(".navbar-custom").removeClass("shadow"):"REVERSE"==$direction&&$(".navbar-custom").addClass("shadow")}).addTo(controller)});new ScrollMagic.Scene({triggerElement:"#header"}).setTween("#header",6,{backgroundColor:"rgba(0,0,0,0.1)"}).addTo(controller),new ScrollMagic.Scene({triggerElement:"#header",offset:"-10%",duration:"110%"}).on("enter",function(e){$(".portfolioBg").css("display","none"),$(".contactBg").css("display","none"),$(".headerBg").css("display","block")}).setTween(".headerBg",{y:"-20%",ease:Linear.easeNone}).addTo(controller),new ScrollMagic.Scene({triggerElement:"#portfolio",triggerHook:"onEnter",offset:"-10%",duration:"200%"}).on("enter",function(e){$(".portfolioBg").css("display","block"),$(".contactBg").css("display","none"),$(".headerBg").css("display","none")}).on("leave",function(e){$direction=e.target.controller().info("scrollDirection"),"REVERSE"==$direction&&($(".portfolioBg").css("display","none"),$(".contactBg").css("display","none"),$(".headerBg").css("display","block"))}).setTween(".portfolioBg",{y:"-20%",ease:Linear.easeNone}).addTo(controller)});var contactScene=new ScrollMagic.Scene({triggerElement:"#contact",triggerHook:"onEnter",offset:"-10%",duration:"110%"}).setTween(".contactBg",{y:"-20%",ease:Linear.easeNone}).on("enter",function(e){$(".portfolioBg").css("display","none"),$(".contactBg").css("display","block"),$(".headerBg").css("display","none")}).on("leave",function(e){$direction=e.target.controller().info("scrollDirection"),"REVERSE"==$direction&&($(".portfolioBg").css("display","block"),$(".contactBg").css("display","none"),$(".headerBg").css("display","none"))}).addTo(controller);navigator.userAgent.match(/Trident\/7\./)&&$("body").on("mousewheel",function(){event.preventDefault();var e=event.wheelDelta,o=window.pageYOffset;window.scrollTo(0,o-e)});